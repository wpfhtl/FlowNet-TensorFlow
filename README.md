...
|--- | --- | --- | --- | --- | --- | --- |
|conv1 	  	| 7 * 7 | 2 | 6/64 		| 1536 * 768 	| 768 * 384 | Images |
|conv2 	  	| 5 * 5 | 1 | 64/128 	| 768 * 384		| 384 * 192 | max_pool1 |
|conv3a 	  	| 5 * 5 | 2 | 128/256 	| 384 * 192		| 192 * 96 	| max_pool2|
|conv3b 		| 3 * 3 | 1 | 256/256	| 192 * 96		| 192 * 96	| max_pool3|
|conv4a 	  	| 5 * 5 | 2 | 256/512 	| 192 * 96		| 96 * 48 	| conv3b|
|conv4b 		| 3 * 3 | 1 | 512/512	| 96 * 48		| 96 * 48	| max_pool4|
|conv5a 	  	| 5 * 5 | 2 | 512/512 	| 96 * 48		| 48 * 24 	| conv4b|
|conv5b 		| 3 * 3 | 1 | 512/512	| 48 * 24		| 48 * 24	| max_pool5|
|conv6a 	  	| 5 * 5 | 2 | 512/512 	| 48 * 24		| 24 * 12	| conv5b|
